...
//
//@Autonomous(name = "蓝 AutoDos 远端（新版机构）", group = "Competition")
//public final class BlueAutoDos extends PathStateAutoBase {
//    private final Pose p00Start = pose(64.275, 9.431, 270);
//    private final Pose p01PreloadScore = pose(53, 14.65060240963856, -70);
//    private final ShotParameters shot01Preload = shot(1831, 0.5195);
//    private final Pose c02PickupReady = pose(40.28915662650603, 4.2409638554216915, 202);
//    private final Pose p02PickupReady = pose(16.57831325301206, 19.66265060240964, 202);
//    private final Pose c03CollectOne = pose(7.27710843373492, 18.313253012048197, 180);
//    private final Pose c03CollectTwo = pose(21.39759036144578, 12.530120481927707, 180);
//    private final Pose p03Pickup = pose(7.90361445783134, 7.518072289156624, 180);
//    private final Pose c04ScoreOne = pose(39.90361445783132, 19.46987951807229, 108);
//    private final Pose p04ScoreOne = pose(51.5, 15, -63);
//    private final ShotParameters shot04One = shot(1826, 0.5194);
//    private final Pose c05PickupReady = pose(40.28915662650603, 4.2409638554216915, 202);
//    private final Pose p05PickupReady = pose(16.57831325301206, 19.66265060240964, 202);
//    private final Pose c06CollectOne = pose(7.27710843373492, 18.313253012048197, 180);
//    private final Pose c06CollectTwo = pose(21.39759036144578, 12.530120481927707, 180);
//    private final Pose p06Pickup = pose(7.90361445783134, 7.518072289156624, 180);
//    private final Pose c07ScoreTwo = pose(39.90361445783132, 19.46987951807229, 108);
//    private final Pose p07ScoreTwo = pose(51.5, 15, -65);
//    private final ShotParameters shot07Two = shot(1826, 0.5194);
//    private final Pose p08Park = pose(38.6, 14.5, -70);
//
...
//    @Override protected String autoName() { return "BlueAutoDos"; }
