...
@Autonomous(name = "红 AutoSiete 远端多次吸球", group = "Competition")
public final class RedAutoSiete extends PathStateAutoBase {
    ...
    private final Pose pickupB1Pose = pose(131.08680645161292, 17.493096774193557, 50);
    ...
    private final Pose pickupA2Pose = pose(133.5, 11, 0);
    ...
    private final Pose pickupB2Pose = pose(131.08680645161292, 17.493096774193557, 50);
    ...
    private final Pose pickupA3Pose = pose(133.5, 11, 0);
    ...
    @Override protected String autoName() { return "RedAutoSiete"; }
